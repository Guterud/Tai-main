    ...
    final class StateModel: BaseStateModel<Provider> {
        ...
        enum ExportCategory: String, CaseIterable, Identifiable {
            ...
            var description: String {
                ...
                case .autoISF:
                    return "AutoISF, B30, and KetoProtect settings"
                case .features:
        ...
        /// - AutoISF settings (AutoISF, B30, KetoProtect) [optional]
        ...
        func exportSettings(
            ...
            if categoriesToExport.contains(.devices) {
                ...
                // CGM Settings
                let cgmSubcategory = String(localized: "CGM")
                addSetting(
                    category: devicesCategory,
                    subcategory: cgmSubcategory,
                    name: String(localized: "CGM"),
                    value: trioSettings.cgm.rawValue
                )
                addSetting(
                    category: devicesCategory,
                    subcategory: cgmSubcategory,
                ...
                // Pump Information
                let pumpSubcategory = String(localized: "Pump")
                if let pumpManager = provider.deviceManager.pumpManager {
                    addSetting(
                        category: devicesCategory,
                        subcategory: pumpSubcategory,
                        name: String(localized: "Pump Type"),
                        value: pumpManager.localizedTitle
                    )
                } else {
                    addSetting(
                        category: devicesCategory,
                ...
                if let pumpSettings = storage.retrieve(OpenAPS.Settings.settings, as: PumpSettings.self) {
                    addSetting(
                        category: devicesCategory,
                        subcategory: pumpSubcategory,
                        name: String(localized: "Max Bolus"),
                    ...
                    addSetting(
                        category: devicesCategory,
                        subcategory: pumpSubcategory,
                        name: String(localized: "Max Basal"),
                ...
                addSetting(
                    ...
                    value: String(describing: trioSettings.insulinConcentration),
                    unit: "U/mL"
                )
                addSetting(
                    category: devicesCategory,
